...
/* ================================================================
   THE INFINITE CYCLE — Main Page Component (with i18n)
   ================================================================ */
  ...
  return (
    <>
      ...
      <nav className="rune-nav" ref={runeNavRef}>
        {[
          { glyph: "𐰃", target: "origin", tip: t("runeNav.origin") },
          { glyph: "𐰖", target: "world-tree", tip: t("runeNav.worldTree") },
          { glyph: "𐱅", target: "pantheon", tip: t("runeNav.pantheon") },
          { glyph: "𐰉", target: "bestiary", tip: t("runeNav.bestiary") },
          { glyph: "𐰼", target: "shadow-realm", tip: t("runeNav.shadowRealm") },
          { glyph: "𐰘", target: "sagas", tip: t("runeNav.sagas") },
        ].map((r, i) => (
